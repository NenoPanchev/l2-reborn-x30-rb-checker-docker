package com.example.l2rebornx30rbcheckerdocker.constants;

public class GlobalConstants {
    public static final String JSON_URL = "https://seasons.l2reborn.org/wp-content/uploads/raids/raids.json";
    public static final String RAID_BOSSES = "src/main/resources/static/jsons/raidbosses.json";
